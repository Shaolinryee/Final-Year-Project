          ...
          <div className="max-w-7xl mx-auto">
             <div className="text-center mb-24">
                ...
                <p className="text-xl text-text-secondary max-w-3xl mx-auto font-medium leading-relaxed">
                    Whether you're a startup, a growing agency, or a larger organization, CollabWeb provides the clarity and structure your team needs to stay organized.
                </p>
             </div>
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                 <div className="relative bg-brand-light p-12 rounded-[48px] border border-brand-border hover:border-brand/30 transition-all shadow-sm hover:shadow-2xl group overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-text-secondary font-medium text-lg mb-10 leading-relaxed italic">Move fast with a clean project structure. Our intuitive Kanban boards help founders focus on building while keeping the team aligned.</p>
                 ...
                 <div className="relative bg-brand-light p-12 rounded-[48px] border border-brand-border hover:border-brand/30 transition-all shadow-sm hover:shadow-2xl group overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <h2 className="text-3xl font-black text-text-primary mb-6 group-hover:text-blue-500 transition-colors">Growing Teams</h2>
                        <p className="text-text-secondary font-medium text-lg mb-10 leading-relaxed italic">Scale with confidence. Role-based access control and activity tracking keep growing organizations organized and accountable.</p>
                 ...
                 <div className="relative bg-brand-light p-12 rounded-[48px] border border-brand-border hover:border-brand/30 transition-all shadow-sm hover:shadow-2xl group overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-text-secondary font-medium text-lg mb-10 leading-relaxed italic">Give students hands-on experience with professional tools. Perfect for group projects, internship programs, and collaborative learning.</p>
                 ...
                 <div className="relative bg-brand-light p-12 rounded-[48px] border border-brand-border hover:border-brand/30 transition-all shadow-sm hover:shadow-xl group overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-text-secondary font-medium text-lg mb-10 leading-relaxed italic">Manage multiple projects with clarity. Keep client work organized with dedicated project boards and team collaboration tools.</p>
